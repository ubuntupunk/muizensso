...
$config = [
    ...
    'callback' => 'https://muizenmesh.co.za/wp/login.php',
    ...
    'providers' => [
        'Twitter' => [ 
            ...
            'keys' => [ 
                'key'    => '3D99HQk85f9mDLRJJLNW7kfjV', //Required: your Twitter consumer key
                'secret' => '28pRQBwM88CrLAQvDiyDHCw6eieoYWoCPbefYc4WzZGyMwOLB7'  //Required: your Twitter consumer secret
            ]
        ],
